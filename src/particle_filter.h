...
class ParticleFilter {  
 public:
  ...
  /**
   * multivGauss Calculates Multivariate-Gaussian Probability Density 
   * @param (x_map, y_map) the world coordinates of one associated landmark 
   * @param (x_mu, y_mu)   the world coordinates of the nearest landmark on the map 
   * @param std_landmark[] Array of dimension 2
   *   [Landmark measurement uncertainty [x [m], y [m]]
   */
  const double multivGauss(double x_map, double y_map, double x_mu, double y_mu, 
                      double std_landmark[]);
